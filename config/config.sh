...
#[ANALYSIS]
#Workflow = aligner-variant_caller. If multiple aligners, comma separated. If multiple callers, colon separated. Aligners:ngmlr,minimap. Callers:sniffles,svim
workflow=minimap-sniffles:svim,ngmlr-sniflles:svim
